...
.config(function($stateProvider, $urlRouterProvider) {
    ...
    .state('tab.home-stats', {
      url: '/home-stats',
      cache: false,      
      views: {
        'tab-region': {
          templateUrl: 'templates/region/homes/region-home-stats.html',
          controller: 'RegionHomeStatsCtrl'
        }
      }
    })                 
    ...
    .state('tab.send-via-message', {
      url: '/send-via-message/{phoneNum}/{email}',
      cache: false,      
      views: {
        'tab-region': {
          templateUrl: 'templates/region/homes/message-template.html',
          controller: 'SendViaMessageCtrl'
        }
      }
    })
    ...
    .state('tab.manage-due-category', {
      url: '/manage-due-category',
      cache: false,
      views: {
        "tab-financial": {
          templateUrl: 'templates/financial/manage-due-category.html',
          controller: 'ManageDueCategoryCtrl'        
        }
      }
    })                        
